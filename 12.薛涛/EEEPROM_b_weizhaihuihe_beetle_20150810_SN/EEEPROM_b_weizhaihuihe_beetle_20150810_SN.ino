            ...
            case  12://串口第4个数字
              ...
              if (anjian == 0)
              {
                            ...
                            
                {
                  ...
                  delay(5000);
                  digitalWrite(projector, HIGH);            //关投影
                  Serial1.println("//shut down computor project ");
                }
                else
                {

               
                  Serial1.println("//4#jian ");
